...
void solve(){
    ...
    for(int i=0; i<=n; i++){
        int fills=i*2+1;
        int max_fills=n*2+1;
        int spaces=max_fills-fills;
        for(int k=0; k<spaces/2; k++)cout<<"  ";
        if(i==0)cout<<0;
        else
            for(int k=0; k<=i; k++)cout<<k<<" ";
    ...
    int i=n-1;
    for(int k=0; k<n; k++){
        for(int z=0; z<spaces/2; z++)cout<<"  ";
        if(i==0)cout<<i;
        else
            for(int z=0; z<=i; z++)cout<<z<<" ";
        for(int z=i-1; z>0; z--)cout<<z<<" ";
        if(i!=0)cout<<0;
        i--;
        spaces=spaces+2;
        cout<<"\n";
