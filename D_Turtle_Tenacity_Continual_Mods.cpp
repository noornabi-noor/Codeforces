...
// bool rearrangePossible(vector<int>& arr) {
...
bool rearrangePossible(std::vector<int>& arr) {
    //sort(arr.begin(), arr.end());
    if (find(arr.begin(), arr.end(), 0) != arr.end()) {
        return false;
    }
...
int main() {
    // Example usage
    std::vector<int> arr1 = {3, 6, 9, 3};
    if (rearrangePossible(arr1)) {
        std::cout << "Rearrangement is possible." << std::endl;
    } else {
        std::cout << "Rearrangement is not possible." << std::endl;
    }

    std::vector<int> arr2 = {2, 2 ,3};
    if (rearrangePossible(arr2)) {
        std::cout << "Rearrangement is possible." << std::endl;
    } else {
        std::cout << "Rearrangement is not possible." << std::endl;
    }
